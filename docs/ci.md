...
| `pnpm-store-warmup`                | Warm the lockfile-pinned Actions cache for fork and non-canonical pull requests plus manual runs without blocking Linux Node shards                                                                                   | Node or docs-check lanes selected outside trusted same-repository runs |
